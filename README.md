...
* *Run command **yarn build*** to build the project - in folder you will have index.html file - this is file with all source code minified and merged, and folder static with react build files
